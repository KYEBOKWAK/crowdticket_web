    ...
    for(let i = 0 ; i < this.state.files.length ; i++){
      ...
      if(!this.state.is_down_expired){
        ...
        if(data.downloadURL === null || data.downloadURL === ''){
          ...
          file_download_a_tags.push(<a key={data.id} className={download_a_tag_name} style={{display: 'none'}} download={data.file.name} href={'https://crowdticket-files.s3-ap-northeast-1.amazonaws.com/local/files/download_file/2/1616658303601/%E1%84%8F%E1%85%B3%E1%84%90%E1%85%B5+%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%84%8B%E1%85%A6%E1%84%8B%E1%85%B5%E1%84%90%E1%85%A5+%E1%84%8B%E1%85%B5%E1%84%87%E1%85%A6%E1%86%AB%E1%84%90%E1%85%B3+%E1%84%80%E1%85%AE%E1%84%86%E1%85%A2+%E1%84%8B%E1%85%A7%E1%86%BC%E1%84%89%E1%85%A1%E1%86%BC+(1)+(1).mov'}></a>)
        }
        ...
        bottomDom = <a className={'circle_button'} download href={'https://crowdticket-files.s3-ap-northeast-1.amazonaws.com/files/KakaoTalk_Video_2020-08-26-17-26-52.mp4'}>
                      <img src={buttonIconImg} />
                    </a>
      }
