    ...
    <div class="container first-container">
        ...
        @if ($order)
            <form class="row form-horizontal" data-toggle="validator" role="form"
                ...
                @else
                    <form class="row form-horizontal" data-toggle="validator" role="form"
                          action="{{ url('/tickets/') }}/{{ $ticket->id }}/orders" method="post">
                        @include('csrf_field')
                        @endif
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="ps-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            @if ($order)
                                                <input id="order-account-name" name="account_name" type="text"
                                                       class="form-control" value="{{ $order->account_name }}"
                                                       readonly="readonly"/>
                                            @else
                                                <input id="order-account-name" name="account_name" type="text"
                        ...
                        <div class="col-md-12">
                            <div class="ps-box">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        @if ($order)
                                            <input id="order-name" name="name" type="text" class="form-control"
                                                   value="{{ $order->name }}" readonly="readonly"/>
                                        @else
                                            <input id="order-name" name="name" type="text" class="form-control"
                        ...
                        @if ($request_price > 0 && $project->type === 'funding')
                            <h4 class="col-md-12 ps-section-title">환불계좌정보 <span>펀딩 마감일까지 목표한 금액이 모이지 않으면 결제하신 금액은 전액 환불됩니다.</span>
                            </h4>
                            <div class="col-md-12">
                                <div class="ps-box">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            @if ($order)
                                                <input id="order-refund-name" name="refund_name" type="text"
                                                       class="form-control" readonly="readonly"
                                                       value="{{ $order->refund_name }}"/>
                                            @else
                                                <input id="order-refund-name" name="refund_name" type="text"
                                                       class="form-control" value="{{ \Auth::user()->name }}"
                                                       required="required"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            @if ($order)
                                                <input id="order-refund-bank" name="refund_bank" type="text"
                                                       class="form-control" readonly="readonly"
                                                       value="{{ $order->refund_bank }}"/>
                                            @else
                                                <input id="order-refund-bank" name="refund_bank" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            @if ($order)
                                                <input id="order-refund-account" name="refund_account" type="text"
                                                       class="form-control" readonly="readonly"
                                                       value="{{ $order->refund_account }}"/>
                                            @else
                                                <input id="order-refund-account" name="refund_account" type="text"
                                                       class="form-control" placeholder="-를 제외하고 입력해주세요"
                                                       required="required"/>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        @else
                            <input id="order-refund-name" name="refund_name" type="hidden" class="form-control"
                                   value="{{ \Auth::user()->name }}" required="required"/>
                            <input id="order-refund-bank" name="refund_bank" type="hidden" class="form-control"
                                   readonly="readonly" value=" "/>
                            <input id="order-refund-account" name="refund_account" type="hidden" class="form-control"
