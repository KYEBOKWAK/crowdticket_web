          ...
          <div>
            ...
            <div class="order_form_conform_container_grid_rows">
              @if($project->isEventTypeDefault())
                ...
                @else
                  @if($project->id === '395')
                    <p>1. 본 이벤트의 티켓 구매, 후원 및 결제 취소 마감일은 2019년 5월 3일 입니다.</p>
                    <p>2. 티켓판매 마감 이후에는 구매 취소 및 취소표의 판매가 이루어지지 않으며 이에 따라 환불이 불가능합니다.</p>
                    <p>3. 관람일 9일전부터는 티켓금액의 10%가 취소 수수료로 부과됩니다.</p>
                    <p>4. 티켓을 구매하지 않고 후원만 참여할 시 환불 수수료가 붙지 않습니다.</p>
                    <p>5. 티켓 환불은 사이트 오른쪽 상단 '결제확인' 탭에서 진행하시면 됩니다.</p>
                  @else
              ...
              @elseif($project->isEventTypeGroupBuy())
                    ...
                    <p style="margin-top:10px;">1. 본 상품은 한정 특가 공동구매 상품으로, 판매 기간 이후 취소 및 환불이 불가합니다.</p>
                    <p>2. 판매 기간(2020-09-24 ~ 2020-09-29)에 한하여, 우측 상단 [결제 확인] 탭에서 취소 및 환불을 진행하실 수 있습니다.</p>
                    <p>3. 판매 기간 내 고객센터 접수 시 100% 취소 및 환불 가능합니다.</p>
                    <p>4. 카드사에 따라 취소 및 환불이 완료될 때까지 영업일 기준 약 2~3일이 소요될 수 있습니다.</p>
                    @endif()
              @elseif($project->isEventCustomType())
