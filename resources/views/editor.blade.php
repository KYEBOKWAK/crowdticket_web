    ...
    <div id="tx_trex_container" class="tx-editor-container">
        ...
        <div id="tx_canvas" class="tx-canvas">
            <div id="tx_loading" class="tx-loading">
                <div><img src="{{ asset('/images/icon/editor/loading2.png') }}" width="113" height="21"
                          align="absmiddle"/>
                </div>
            </div>
        ...
        <div id="tx_resizer" class="tx-resize-bar">
            ...
            <img id="tx_resize_holder" src="{{ asset('/images/icon/editor/skin/01/btn_drag01.gif') }}" width="58"
                 height="12" unselectable="on" alt=""/>
        </div>
        <div class="tx-side-bi" id="tx_side_bi">
            <div style="text-align: right;">
                <img hspace="4" height="14" width="78" align="absmiddle"
                     src="{{ asset('/images/icon/editor/editor_bi.png') }}"/>
            </div>
        </div>
    </div>
</form>
