        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 box-container">
                    ...
                    <h5>
                        본 페이지는 운영진만이 열람할 수 있는 프로젝트 개설신청을 위한 기본정보를 입력하는 공간이기 때문에 자유롭게 입력해 주셔도 좋습니다! 하지만 운영진이 여러분과 여러분의
                        프로젝트에 대해 가늠할 수 있도록 최대한 구체적으로 질문에 답해주세요!
                    </h5>
                    <form action="{{ url('/blueprints') }}" method="post" data-toggle="validator" role="form">
                        ...
                        <div class="form-group">
                            @if (Input::get('type') === 'funding')
                                ...
                                <input id="input-amount" name="estimated_amount" type="number" placeholder="원"
                            ...
                            @else
                                ...
                                <input id="input-amount" name="estimated_amount" type="text" class="form-control"
                                       required/>
                                <p class="help-block">
