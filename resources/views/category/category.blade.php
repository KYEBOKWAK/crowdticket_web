...
@section('css')
  ...
  <link href="{{ asset('/dist/css/Category_Result_List.css?version=2') }}" rel="stylesheet"/>
  ...
  <link href="{{ asset('/dist/css/Category_Creator_List.css?version=1') }}" rel="stylesheet"/>
...
@section('js')
<script type="text/javascript" src="{{ asset('/dist/App_Category.js?version=8') }}"></script>
@endsection
