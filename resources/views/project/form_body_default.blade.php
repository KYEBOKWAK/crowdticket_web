    ...
    <div class="form-horizontal" data-toggle="validator" role="form">
        ...
        @if ($project->type === 'sale')
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input id="concert_hall" name="concert_hall" maxlength="16" type="text" placeholder="공연장 이름 입력"
                           class="form-control" value="{{ $project->concert_hall }}"
                           @if ($project->isPublic()) readonly="readonly" @endif />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="detailed_address" name="detailed_address" maxlength="128" type="text"
                           placeholder="세부 주소 입력" class="form-control" value="{{ $project->detailed_address }}"
                           @if ($project->isPublic()) readonly="readonly" @endif />
                </div>
            </div>
        @endif
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="input-group col-sm-4">
                        <input id="pledged_amount" name="pledged_amount" type="number" class="form-control"
                               value="{{ $project->pledged_amount }}"
                               @if ($project->isPublic()) readonly="readonly" @endif />
        ...
        @endif
        <div class="form-group">
            <label for="funding_closing_at" class="col-sm-2 control-label">@if ($project->type === 'funding') 펀딩
                마감일 @else 티켓팅 마감일 @endif</label>
            <div class="col-sm-2">
