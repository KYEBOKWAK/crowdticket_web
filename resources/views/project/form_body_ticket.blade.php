...
<div class="row">
    <div class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                ...
                <label class="help-block">
                    @if ($project->type === 'funding')
                        <input id="ticket_require_shipping" name="require_shipping" type="checkbox" value=""/>보상품의 제공을
                        위해 후원자의 주소가 필요한가요?
                    @else
        ...
        <div class="form-group" @if ($project->type !== 'funding') style="display:none;" @endif>
            ...
            <div class="col-sm-8">
                <textarea id="ticket_question" name="question" class="form-control"></textarea>
                <p class="help-block">후원자에게 공연관람 일정, 보상 사이즈 등 추가사항을 문의할 수 있습니다</p>
                <label class="help-block">
                    <input id="ticket_require_question" name="require_question" type="checkbox" value=""/>질문이 필요 없습니다.
                </label>
            </div>
        </div>
        <div class="form-group">
            ...
            <div @if ($project->type === 'funding') class="col-sm-6" @else class="col-sm-4" @endif>
                <div class="input-group">
                    ...
                    <input id="ticket_audiences_limit" name="audiences_limit" type="number" class="form-control"
                           @if ($project->type === 'funding') min="0" value="0" @else min="1" value="1" @endif />
                    <div class="input-group-addon">
                        @if ($project->type === 'funding')
                            명으로 제한합니다.
                        @else
