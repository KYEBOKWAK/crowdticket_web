...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('/css/project/form_body_required.css?version=6') }}"/>
    <link rel="stylesheet" href="{{ asset('/css/welcome.css?version=5') }}"/>
...
@section('js')
    ...
    <script src="{{ asset('/js/project/form.js?version=11') }}"></script>
    ...
    <script src="{{ asset('/js/editor/summernote-lite-crowdticket.js?version=4') }}"></script>
@endsection
