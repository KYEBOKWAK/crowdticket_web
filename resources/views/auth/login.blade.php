...
@section('css')
  ...
  <link href="{{ asset('/dist/css/LoginStartPage.css?version=0') }}" rel="stylesheet"/>
  <link href="{{ asset('/dist/css/LoginEmailPage.css?version=0') }}" rel="stylesheet"/>

  <link href="{{ asset('/dist/css/LoginKnowSNSPage.css?version=0') }}" rel="stylesheet"/>
  <link href="{{ asset('/dist/css/LoginForgetEmailPage.css?version=0') }}" rel="stylesheet"/>
  <link href="{{ asset('/dist/css/LoginSNSSetEmailPage.css?version=0') }}" rel="stylesheet"/>
  <link href="{{ asset('/dist/css/LoginJoinPage.css?version=0') }}" rel="stylesheet"/>
