          ...
          <table class="main-container" cellpadding="0" cellspacing="0" align="center" border="0" style="margin:0px auto;padding:40px 0;width:100%;max-width:630px;background:rgb(255,255,255)">
            <tbody><tr style="margin:0;padding:0">
              <td style="width:100%;max-width:630px;border-collapse:separate;padding:0 20px;overflow:hidden">
                ...
                <table class="email-title" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:0px;width:100%;max-width:630px;clear:both;background:none">
                  <tbody><tr>
                    <td style="font-family:'Noto Sans KR',sans-serif;font-size:24px;;font-weight:bold;font-stretch:normal;font-style:normal;line-height:normal;letter-spacing:normal;color:#212121">
                      <div style="text-align:left">이벤트 개설을<br/>시작하셨군요!</div>
                    </td>
                  </tr></tbody>
                </table>
                <table class="khaem-block" border="0" cellspacing="0" cellpadding="0" style="overflow:hidden;margin:32px auto;padding:0;width:100%;max-width:590px;clear:both;align:center;background-color:#f9f9f9">
                  <tr><td>
                    <table class="khaem-container" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0 auto;padding:0;width:100%;white-space:nowrap;max-width:335px;background:none">
                      <tr>
                        <td align="right" style="padding:32px 11px 8px 20px">
                          <table style="width:100px;height:22px;border-radius:10px;box-shadow:8px 8px 14px 0 rgba(0, 0, 0, 0.1);background-color:#ffffff;text-align:center">
                            <tr>
                              <td style="padding:9px 12px;text-align:right;font-family:'Noto Sans KR',NotoSansCJKkr,sans-serif;font-size:14px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.57;letter-spacing:normal;color:#212121">
                                크티와 함께
                              </td>
                            </tr>
                          </table>
                        </td>
                        <td rowspan="3" style="vertical-align:bottom;padding-right:9px">
                          <img alt="크햄" src="https://crowdticket0.s3-ap-northeast-1.amazonaws.com/admin/mail/rebrand/img-kham-email.png" class="img_kham_lucas" style="width:100px; height:75px; object-fit: contain;vertical-align:bottom" />
                        </td>
                      </tr>
                      <tr>
                        <td align="right" style="padding:0 11px 32px 20px">
                          <table style="width:162px;height:22px;border-radius:10px;box-shadow:8px 8px 14px 0 rgba(0, 0, 0, 0.1);background-color:#ffffff;text-align:center;">
                            <tr>
                              <td style="padding:9px 12px;text-align:right;font-family:'Noto Sans KR',NotoSansCJKkr,sans-serif;font-size:14px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.57;letter-spacing:normal;color:#212121">
                                이벤트를 시작하자햄!
                              </td>
                ...
                <table class="email-content" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding-bottom:32px;width:100%;max-width:630px;clear:both;background:none">
                  <tr>
                    <td>
                      <table class="explain-paragraph" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:0px;width:100%;max-width:630px;clear:both;background:none">
                        <tr>
                          <td style="padding:0px 0px;font-family:'Noto Sans KR',sans-serif;font-size:14px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.71;letter-spacing:normal;color:#575757;word-break:keep-all">
                            <div style="text-align:left">안녕하세요 <span style="font-weight:900;color:#43c9f0">{{ $name }}</span>님,<br/>크티에서 이벤트 개설 신청을 해주셔서 감사합니다.</div>
                          </td>
                        </tr>
                      </table>
                      <table class="explain-paragraph" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:24px 0 0 0;width:100%;max-width:630px;clear:both;background:none">
                        <tr>
                          <td style="padding:0px 0px;font-family:'Noto Sans KR',sans-serif;font-size:14px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.71;letter-spacing:normal;color:#575757;word-break:keep-all">
                            <div style="text-align:left">크티는 크리에이터 온/오프라인 이벤트 솔루션으로, 온라인 이벤트 및 소규모 팬미팅부터 1000명 이상 규모의 페스티벌까지 필요에 따라 기획/관리/운영을 모두 진행해드리고 있습니다.</div>
                          </td>
                        </tr>
                      </table>
                      <table class="explain-paragraph" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:24px 0 0 0;width:100%;max-width:630px;clear:both;background:none">
                        <tr>
                          <td style="padding:0px 0px;font-family:'Noto Sans KR',sans-serif;font-size:14px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.71;letter-spacing:normal;color:#575757;word-break:keep-all">
                            <div style="text-align:left">신청해주신 정보는 맞춤형 이벤트 준비를 위해 확인한 후 필요에 따라 연락을 드릴게요! 연락은 <b>평일 오전 10시 ~ 오후 7시 사이</b>에 드리고 있으며, 크리에이터님이 원하시는 이벤트에 대해 간단한 질문을 드릴 예정입니다. &#128516;</div>
                          </td>
                        </tr>
                      </table>
                      <table class="explain-paragraph" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:24px 0 0 0;width:100%;max-width:630px;clear:both;background:none">
                        <tr>
                          <td style="padding:0px 0px;font-family:'Noto Sans KR',sans-serif;font-size:14px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.71;letter-spacing:normal;color:#575757;word-break:keep-all">
							<div style="text-align:left">이벤트 준비가 시작되기 전에 먼저 물어보고 싶은 것이 있거나 사전 설명이 필요하다면 이메일 답장으로 알려주세요!</div>
                          </td>
                        </tr>
					  </table>
					  <table class="explain-paragraph" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:24px 0 0 0;width:100%;max-width:630px;clear:both;background:none">
						<tr>
                          <td style="padding:0px 0px;font-family:'Noto Sans KR',sans-serif;font-size:11px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.71;letter-spacing:normal;color:#888888;word-break:keep-all">
							<div style="text-align:left"><b>*</b>신청 정보가 허위사실이거나 이벤트가 크티에서 진행하기에 부적합하다고 판단되는 경우에는 개설 승인이 안될 수도 있습니다.</div>
						  </td>
                        </tr>
					  </table>
                      <hr width="100%" size="1px" align="center" color="#ebebeb" style="margin:20px 0px 0px 0px"/>
                      <table class="explain-paragraph" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:24px 0 0 0;width:100%;max-width:630px;clear:both;background:none">
                        <tr>
                          <td style="padding:0px 0px;font-family:'Noto Sans KR',sans-serif;font-size:14px;font-weight:normal;font-stretch:normal;font-style:normal;line-height:1.71;letter-spacing:normal;color:#575757;word-break:keep-all">
                            <div style="text-align:left">궁금한 점이 있거나 빠른 답장을 원하시나요?<br/>아래 버튼을 눌러 카톡 대화를 시작하실 수 있습니다. &#x1F4AC;	</div>
                          </td>
                        </tr>
                      </table>
                    </td>
                      ...
                      <table class="cti-button" border="0" cellpadding="0" cellspacing="0" width="" style="border-collapse:separate!important;background:#43c9f0;border-radius:5px;border:0;margin:0 auto;table-layout:fixed" align="left">
                        <tbody><tr>
                          <td style="padding:12px 20px" align="center">
                            <a href="http://pf.kakao.com/_JUxkxjM/chat" target="_blank" style="font-size:14px;display:block;color:#ffffff;text-decoration:none;font-family:'Noto Sans KR',sans-serif;text-align:center">대화 시작하기</a>
                          </td>
                        </tr></tbody>
                      </table>
                    </td>
