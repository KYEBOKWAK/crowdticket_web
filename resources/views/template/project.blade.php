                    ...
                    <div>
                        @if ($project->isPublic())
                            ...
                            <h4 class="text-ellipsize project-title"><a
                                        href="{{ url('/projects') }}/{{ $project->id }}">{{ $project->title }}</a></h3>
                                @else
                                    ...
                                    <h4 class="text-ellipsize project-title"><a
                                                href="{{ url('/projects') }}/form/{{ $project->id }}">{{ $project->title }}</a></h3>
                                        @endif
                                        <h6 class="text-ellipsize-2 project-description">{{ $project->description }}
                                    </h4>
                    </div>
