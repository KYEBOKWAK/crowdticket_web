<script type="text/template" id="template_channel">
  <div data-channel-id="<%= channel.id %>" class="channel">
    <div class="flex_layer">
      <select id="channel_category<%= index %>" name="channel_category<%= index %>" class="channel_category project_form_input_base project_form_creator_channel_input">
      ...
      <input id="channel_category_url_input<%= index %>" name="channel_category_url_input<%= index %>" class="channel_category_url_input project_form_input_base project_form_creator_channel_url_input" type="text" value="<%= channel.url %>" placeholder="페이지 주소" />
