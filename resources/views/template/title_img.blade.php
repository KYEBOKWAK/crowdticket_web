<div class="flex_layer">
  <div class="project_form_poster_img_bg">
    <div class="project_form_poster_origin_size_ratio_poster_title">
      <div class="project_form_poster_origin_size">
        ...
        <img id="title_img_preview_{{ $img_num }}" onload="imageResize($('.project_form_poster_origin_size')[0], this)" class="title_img_preview" style="display:none;"/>
