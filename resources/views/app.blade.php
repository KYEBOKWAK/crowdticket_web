...
<!-- Fonts -->
    ...
    <script type="text/javascript" src="{{ asset('/js/util_header.js?version=10') }}"></script>
...
<?php
  $loginFilePath = asset('/js/fblogin.js?fbid='.env('FACEBOOK_ID').'&fbver='.env('FACEBOOK_VER').'&ggid='.env('GOOGLE_ID').'&version=13');
?>
