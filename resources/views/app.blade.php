...
<script src="{{ asset('/js/util.js?version=28') }}"></script>
...
<?php
  $loginFilePath = asset('/js/fblogin.js?fbid='.env('FACEBOOK_ID').'&fbver='.env('FACEBOOK_VER').'&ggid='.env('GOOGLE_ID').'&version=10');
?>
